...
var GUN = ['........................O...........',
           ...
           '...........O...O....................',
           '............OO......................'];
var GX = 18, GY = 31, DEAD = 272;   // centred, for the look of it, and nothing else
function gun(){
  board.clear();
...
function say(){
  ...
  else if (scene === 'gun' && board.gen() < DEAD)
    text = "Gosper's gun · five more cells every thirty generations";
  else if (scene === 'gun')
    text = 'The gun is gone · its own stream came round at ' + DEAD;
